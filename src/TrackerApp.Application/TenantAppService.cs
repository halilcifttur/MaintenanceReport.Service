...
[ExposeServices(typeof(Volo.Abp.TenantManagement.ITenantAppService))]
public class TenantAppService : TenantManagementAppServiceBase, ITenantAppService
{
    ...
    public virtual async Task<TenantDto> CreateAsync(MyTenantCreateDto input)
    {
        var tenant = await TenantManager.CreateAsync(input.Name);
        input.MapExtraPropertiesTo(tenant);

        tenant.SetProperty("country", input.Country);
        tenant.SetProperty("city", input.City);
    ...
    public virtual async Task<TenantDto> UpdateAsync(Guid id, MyTenantUpdateDto input)
    {
